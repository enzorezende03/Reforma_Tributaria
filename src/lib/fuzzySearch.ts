...
const synonyms: Record<string, string[]> = {
  ...
  // === SERVIÇOS DE SAÚDE HUMANA (CST 200 - Anexo III - cClassTrib 200030) ===
  "saude": ["saude humana", "servicos de saude humana", "anexo iii"],
  "saude humana": ["saude", "servicos de saude humana", "anexo iii"],
  "servicos de saude": ["saude humana", "servicos de saude humana", "anexo iii"],
  "servicos de saude humana": ["saude humana", "saude", "anexo iii"],
  "cirurgico": ["cirurgicos", "cirurgia", "saude humana", "servicos de saude humana", "anexo iii"],
  "cirurgicos": ["cirurgico", "cirurgia", "saude humana", "servicos de saude humana", "anexo iii"],
  "cirurgia": ["cirurgico", "cirurgicos", "saude humana", "servicos de saude humana", "anexo iii"],
  "hospital": ["hospitalar", "saude humana", "servicos de saude humana", "anexo iii"],
  "hospitalar": ["hospital", "saude humana", "servicos de saude humana", "anexo iii"],
  "internacao": ["hospital", "hospitalar", "saude humana", "servicos de saude humana", "anexo iii"],
  "clinica": ["clinico", "saude humana", "servicos de saude humana", "anexo iii"],
  "clinico": ["clinica", "saude humana", "servicos de saude humana", "anexo iii"],
  "consulta": ["consulta medica", "consultas medicas", "saude humana", "servicos de saude humana", "anexo iii"],
  "consulta medica": ["consulta", "consultas medicas", "saude humana", "servicos de saude humana", "anexo iii"],
  "consultas medicas": ["consulta medica", "consulta", "saude humana", "servicos de saude humana", "anexo iii"],
  "exame": ["exames", "diagnostico", "saude humana", "servicos de saude humana", "laboratorio", "anexo iii"],
  "exames": ["exame", "diagnostico", "saude humana", "servicos de saude humana", "laboratorio", "anexo iii"],
  "diagnostico": ["exame", "exames", "saude humana", "servicos de saude humana", "anexo iii"],
  "laboratorio": ["exame", "exames", "saude humana", "servicos de saude humana", "analises clinicas", "anexo iii"],
  "fisioterapia": ["saude humana", "reabilitacao", "servicos de saude humana", "anexo iii"],
  "fonoaudiologia": ["saude humana", "servicos de saude humana", "anexo iii"],
  "nutricao": ["saude humana", "nutricionista", "servicos de saude humana", "anexo iii"],
  "nutricionista": ["nutricao", "saude humana", "servicos de saude humana", "anexo iii"],
  "odontologia": ["odontologico", "dentista", "saude humana", "servicos de saude humana", "anexo iii"],
  "odontologico": ["odontologia", "dentista", "saude humana", "servicos de saude humana", "anexo iii"],
  "dentista": ["odontologia", "odontologico", "saude humana", "servicos de saude humana", "anexo iii"],
  "enfermagem": ["enfermeiro", "saude humana", "servicos de saude humana", "anexo iii"],
  "enfermeiro": ["enfermagem", "saude humana", "servicos de saude humana", "anexo iii"],
  "ambulancia": ["transporte de pacientes", "saude humana", "servicos de saude humana", "emergencia", "anexo iii"],
  "emergencia": ["urgencia", "pronto socorro", "saude humana", "servicos de saude humana", "anexo iii"],
  "urgencia": ["emergencia", "pronto socorro", "saude humana", "servicos de saude humana", "anexo iii"],
  "pronto socorro": ["emergencia", "urgencia", "saude humana", "servicos de saude humana", "anexo iii"],
  ...
  "medicina": ["saude humana", "servicos de saude humana", "medico", "consulta medica", "anexo iii"],
  "medico": ["saude humana", "servicos de saude humana", "medicina", "consulta medica", "consultas medicas", "anexo iii"],
  "psicologia": ["saude humana", "servicos de saude humana", "psicologo", "anexo iii"],
  "psicologo": ["saude humana", "servicos de saude humana", "psicologia", "anexo iii"],
